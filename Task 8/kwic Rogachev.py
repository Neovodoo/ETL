...
class KWIC:
    def __init__(self):
        ...
        self.input_manager = input_mech(self.storage)
        self.circular_shifter = line_shift(self.storage)
        self.alphabetizer = sorter(self.storage)
        self.output_manager = output_mech(self.alphabetizer)

    def execute(self):
        self.input_manager.read_input()
        self.circular_shifter.make_shift()
        self.alphabetizer.sort_lines()
        self.output_manager.write_output()
